                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12 grid-margin transparent">
                            <div class="row">
                                <a href="/videos" class="text-decoration-none border border-0 col-md-6 mb-4 stretch-card transparent">
                                    <div class="card card-tale">
                                        <div class="card-body">
                                            <p class="fs-4 fw-bold mb-4">Data Video UI</p>
                                            <p class="fs-2 fw-bold">{{ $videoCount }}</p>
                                            <p class="fs-4 fw-bold">NOW</p>
                                        </div>
                                    </div>
                                </a>  
                                <a href="/blog" class="text-decoration-none border border-0 col-md-6 mb-4 stretch-card transparent">
                                    <div class="card card-dark-blue">
                                        <div class="card-body">
                                            <p class="fs-4 fw-bold mb-4">Data Blog UI</p>
                                            <p class="fs-2 fw-bold">{{ $blogs }}</p>
                                            <p class="fs-4 fw-bold">NOW</p>
                                        </div>
                                    </div>
                                </a>
