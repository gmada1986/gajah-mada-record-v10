                ...
                <ul class="nav">
                    ...
                    <li class="nav-item active">
                        ...
                        <div class="collapse" id="tables">
                            ...
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="dashboard/blog">Data Blog</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-5">
                                        ...
                                        <a href="{{ route('dashboard.videos.create') }}" class="btn btn-primary">Add
                                            Video</a>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $video->judul }}</td>
                                                    <td><img src="{{ $video->thumbnail }}" alt="{{ $video->judul }}"
                                                            width="100"></td>
                                                    <td>
                                                        ...
                                                        <form
                                                            action="{{ route('dashboard.videos.destroy', $video->id) }}"
                                ...
                                <section class="mx-auto text-center">
                                    <img src="{{ asset('asset/logo-dashboard/video-gajah-mada.jpg') }}" width="1000" height="auto" alt="logo" class="rounded" />
                                </section>
                                <section class="container p-3">
                                    <h5>Page ini untuk mengganti atau menambahkan Video Youtube dari website tersebut,jika ada perubah bisa di ganti dengan mengubah nya lewat local,jika ada yang di tanyakan lagi bisa HUB pihak developer nya</h5>
                                </section>
                            </div>
                        </div>
