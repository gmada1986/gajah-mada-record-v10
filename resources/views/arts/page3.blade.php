...
<body>
                ...
                <center>
                    <div class="row content-center-one">
                        ...
                        <div class="col-xl-9 mt-5 mb-4 lne-hght">
                            <a href="https://www.instagram.com/raysurajaya/"> 
                        ...
                        <div class="col-xl-9 mb-4 mt-2 lne-hght">
                            <a href="https://open.spotify.com/intl-id/artist/2IjBydGpTxzRpXJyu8XvUL">
                                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" class="rspnsive-iconx"
                                    viewBox="0 0 256 256">
                                    <path fill="#1ED760"
                        ...
                        <div class="col-xl-9 lne-hght">
                            <a href="https://www.youtube.com/watch?v=MGS3Fkalf8M">
    ...
    <div class="ngtop" style="margin-top: 9%;">
        <h1 class="text-center fw-bold text-white" style="margin-top: 4%;">RAY SURAJAYA</h1>
        <center>
    ...
    <div class="container text-white" style="margin-top: 6%;">
        <div class="mb-3" style="max-width: 100%;">
            <div class="row g-0">
                <center>
                    <img src="https://cdn1-production-images-kly.akamaized.net/oY9QXpfbBwVti_bi7nRcNIMcvng=/500x281/smart/filters:quality(75):strip_icc():format(webp)/kly-media-production/medias/3355985/original/007983700_1611240183-ann2.jpg"
            ...
            <div class="row">
                <div class="col-xl-10" style="max-width: 1020px; justify-content: center;align-content: center;margin: auto;display: flex;">
                    <p class="card-text">Penyanyi asal Jakarta yang
                        memiliki suara khas dan
                        lembut. Ray Surajaya atau yang memiliki nama asli Muhammad Rayhan Surajaya adalah musisi kelahiran 24 Juli 2002 asal Jakarta. Mempunyai nama panggilan Ihan,Ray dan Surjay yang dikenal lewat unggahan coveran miliknya di tik tok dengan lagu Anneth Mungkin hari ini esok atau nanti dan Melukis senja di Channel  Youtube miliknya.</p>
                </div>
                <p>&nbsp;</p>
                <div class="col-xl-10" style="max-width: 1020px; justify-content: center;align-content: center;margin: auto;display: flex;">
                    <p class="card-text text-break">
                        Melukis senja yang ia cover pada tanggal 31 Oktober 2020 bahkan sudah mencapai 7 juta tayangan gaes. Dan sempat viral dan trending dikalangan anak muda berbarengan dengan salah satu penyanyi Mitty Zasia yang juga menyanyikan lagu ini. 
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-xl-4">
                <p><iframe loading="lazy" src="https://open.spotify.com/embed/artist/2IjBydGpTxzRpXJyu8XvUL"
                        width="100%" height="380" frameborder="0"></iframe></p>
            </div>
            <div class="col-xl-4">
                <div style="margin-top: 15%; margin-bottom: 10%;">
                    <p style="position: relative;">
                        <a href="https://www.youtube.com/watch?v=MGS3Fkalf8M" target="_blank">
                            <img src="https://img.youtube.com/vi/MGS3Fkalf8M/maxresdefault.jpg" 
                                 width="100%" 
                                 height="100%" 
            ...
            <div class="col-xl-4">
                <p><iframe src="https://www.instagram.com/raysurajaya/embed" style="border-radius: 10px;"
