...
<body>
                ...
                <center>
                    <div class="row content-center-one">
                        ...
                        <div class="col-xl-9 mt-5 mb-4 lne-hght">
                            <a href="https://www.instagram.com/akustik_kotatua/"> 
                        ...
                        {{-- <div class="col-xl-9 mb-4 mt-2 lne-hght">
                            <a href="https://open.spotify.com/intl-id/artist/71Mly2XJZ9F0bVbYlmmr5F">
                                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" class="rspnsive-iconx"
                                    viewBox="0 0 256 256">
                                    <path fill="#1ED760"
                        ...
                        <div class="col-xl-9 lne-hght">
                            <a href="https://www.youtube.com/watch?v=5D4wYpqsZ7U">
    ...
    <div class="ngtop" style="margin-top: 9%;">
        <h1 class="text-center fw-bold text-white" style="margin-top: 4%;">AKUSTIK KOTA TUA</h1>
        <center>
    ...
    <div class="container text-white" style="margin-top: 6%;">
        <div class="mb-3" style="max-width: 100%;">
            <div class="row g-0">
                <center>
                    <img src="asset/akustik_kotatua.jpg"
            ...
            <div class="row">
                <div class="col-xl-10" style="max-width: 1020px; justify-content: center;align-content: center;margin: auto;display: flex;">
                    <p class="card-text">Akustik Kota Tua ikut meramaikan pengunjung wisata di kawasan Kota Tua tepatnya di sekitar Museum Fatahilah, Jakarta Barat.</p>
                </div>
                <p>&nbsp;</p>
                <div class="col-xl-10" style="max-width: 1020px; justify-content: center;align-content: center;margin: auto;display: flex;">
                    <p class="card-text text-break">
                        Hardy Sekawan management Akustik Kota tua dan Ksatria Rangga Buana (Ketua Akustik Kota Tua) mengatakan, antusias pengunjung kota tua sangat senang dan terhibur dengan adanya musik akustik kota tua di sekitar wilayah Museum Fatahillah.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <div class="row" style="justify-content: center;align-content: center; margin: auto;">
            <div class="col-xl-4">
                <div style="margin-top: 15%; margin-bottom: 10%;">
                    <p style="position: relative;">
                        <a href="https://www.youtube.com/watch?v=5D4wYpqsZ7U" target="_blank">
                            <img src="https://img.youtube.com/vi/5D4wYpqsZ7U/maxresdefault.jpg" 
                                 width="100%" 
                                 height="100%" 
            ...
            <div class="col-xl-4">
                <p><iframe src="https://www.instagram.com/akustik_kotatua/embed" style="border-radius: 10px;"
