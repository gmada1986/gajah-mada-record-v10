...
<body>
                ...
                <center>
                    <div class="row content-center-one">
                        ...
                        <div class="col-xl-9 mt-5 mb-4 lne-hght">
                            <a href="https://www.instagram.com/da2_rizki123/"> 
                        ...
                        <div class="col-xl-9 mb-4 mt-2 lne-hght">
                            <a href="https://open.spotify.com/intl-id/artist/27e0eSf9zdOb8EklwFNVW7">
                                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" class="rspnsive-iconx"
                                    viewBox="0 0 256 256">
                                    <path fill="#1ED760"
                        ...
                        <div class="col-xl-9 lne-hght">
                            <a href="https://www.youtube.com/watch?v=O-BXWJolrhs">
    ...
    <div class="ngtop" style="margin-top: 9%;">
        <h1 class="text-center fw-bold text-white" style="margin-top: 4%;">RIZKI RIDHO</h1>
        <center>
    ...
    <div class="container text-white" style="margin-top: 6%;">
        <div class="mb-3" style="max-width: 100%;">
            <div class="row g-0">
                <center>
                    <img src="asset/rizki_ridho.jpg"
                        class="img-fluid rounded mb-5" alt="..." style="width: 1000px;">
                </center>
            </div>
            <div class="row">
                <div class="col-xl-10" style="max-width: 1020px; justify-content: center;align-content: center;margin: auto;display: flex;">
                    <p class="card-text">Rizki menikah dengan Nadya Mustika Rahayu pada 17 Juli 2020 setelah melalui proses taaruf. Pernikahan mereka digelar di Bandung, Jawa Barat. Sebelum menikah dengan Nadya, Rizki pernah menjalin hubungan dengan Lesti Kejora selama 5 tahun. Namun karena terlalu sering dirundung masalah, Rizki mentalak cerai Nadya pada 22 Agustus 2020. Setahun berselang, Rizki memutuskan rujuk dengan Nadya. Tepat pada 19 Juli 2021, pasangan ini kembali membangun rumah tangga dan melakukan akad nikah ulang di Medan, Sumatera Utara.</p>
                </div>
                <p>&nbsp;</p>
                <div class="col-xl-10" style="max-width: 1020px; justify-content: center;align-content: center;margin: auto;display: flex;">
                    <p class="card-text text-break">
                        Rizki kemudian kembali mengajukan talak cerai Nadya pada 23 November 2021. Rizki akhirnya resmi bercerai dengan Nadya pada 9 Desember 2021 melalui keputusan verstek. Pasangan ini dikaruniai seorang putra bernama Baihaqqi Syaki Ramadhan pada 13 April 2021. Pada 9 Desember 2023, Rizki menikah kedua kalinya dengan Hersa Rahayu Julianti dan prosesi ijab kabul tersebut diselenggarakan di Bandung.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-xl-4">
                <p><iframe loading="lazy" src="https://open.spotify.com/embed/artist/27e0eSf9zdOb8EklwFNVW7"
                        width="100%" height="380" frameborder="0"></iframe></p>
            </div>
            <div class="col-xl-4">
                <div style="margin-top: 15%; margin-bottom: 10%;">
                    <p style="position: relative;">
                        <a href="https://www.youtube.com/watch?v=O-BXWJolrhs" target="_blank">
                            <img src="https://img.youtube.com/vi/O-BXWJolrhs/maxresdefault.jpg" 
                                 width="100%" 
                                 height="100%" 
            ...
            <div class="col-xl-4">
                <p><iframe src="https://www.instagram.com/da2_rizki123/embed" style="border-radius: 10px;"
