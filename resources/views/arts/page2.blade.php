...
<body>
                ...
                <center>
                    <div class="row content-center-one">
                        ...
                        <div class="col-xl-9 mt-5 mb-4 lne-hght">
                            <a href="https://www.instagram.com/axlramanda/">
                        ...
                        <div class="col-xl-9 mb-4 mt-2 lne-hght">
                            <a href="https://open.spotify.com/intl-id/artist/6OJKPCiRnBW1UqYvEC276L">
                                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" class="rspnsive-iconx"
                                    viewBox="0 0 256 256">
                                    <path fill="#1ED760"
                        ...
                        <div class="col-xl-9 lne-hght">
                            <a href="https://www.youtube.com/watch?v=lhiJ40JTv1A">
                                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" class="rspnsive-iconx"
                                    viewBox="0 0 72 72">
                                    <path fill="#ea5a47"
                            ...
                            <div class="mt-5">
                                <div class="text-white text-center">
                                    <a href="https://www.privacypolicyonline.com/live.php?token=bZA39cwOgezk9XD5jDqEz3gQORm4yjW4"
                                        class="rspnsv-txt text-white fs-6 text-decoration-none text-center">Terms &amp;
                                        Conditions || Privacy Policy</a>
                                    <p class="text-white-50 fs-6 rspnsv-txt">Copyright @ 2023 Gajah Mada Record All
                                        Right Reserved</p>
                                </div>
                            </div>
                        </footer>
    ...
    <div class="ngtop">
        <h1 class="text-center fw-bold text-white" style="margin-top: 4%;">AXL RAMANDA</h1>
        <center>
        ...
        <div class="mb-3" style="max-width: 100%;">
            ...
            <div class="row">
                <div class="col-xl-10"
                    ...
                    <p class="card-text">Axl Ramanda is an Indonesian pop-rock singer and songwriter. Inspired by
                        various
                        great pop-rock singers such as Steve Perry by Journey, Steven Tyler, Freddy
                        Mercury, Robert Plan, Bryan Adams, Ari Lasso, Once Mekel, and many more. Axl Ramanda starting his music journey on 2021 as a soloist with his own
                        management called “ARPRO”.</p>
                </div>
                <p>&nbsp;</p>
                <div class="col-xl-10"
                    style="max-width: 1020px; justify-content: center;align-content: center;margin: auto;display: flex;">
                    <p class="card-text text-break">
                        Currently Axl Ramanda has joined one of the legendary music label “GAJAH MADA
                        RECORD” and Axl Ramanda also spent his career as the vocalist of a well-known
                        Band in Indonesia called “DRIVE”.
                    </p>
                </div>
                <p>&nbsp;</p>
                <div class="col-xl-10"
                    style="max-width: 1020px; justify-content: center;align-content: center;margin: auto;display: flex;">
                    <p class="card-text text-break">
                        In 2021, Axl Ramanda took part in the biggest talent search event in Indonesia
                        called “Indonesian Idol” and succeeded in achieving TOP 11 achievements. As a
                        soloist, Axl specializes in writing songs that relate to many people and presents
                        energetic pop songs and heartbreaking songs to accompany the stories in your life.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-xl-4">
                <p><iframe loading="lazy" src="https://open.spotify.com/embed/artist/6OJKPCiRnBW1UqYvEC276L"
                        width="100%" height="380" frameborder="0"></iframe></p>
            </div>
            <div class="col-xl-4">
                <div style="margin-top: 15%; margin-bottom: 10%;">
                    <p style="position: relative;">
                        <a href="https://www.youtube.com/watch?v=lhiJ40JTv1A" target="_blank">
                            <img src="https://img.youtube.com/vi/lhiJ40JTv1A/maxresdefault.jpg" width="100%"
                                height="100%" style="border-radius: 10px; object-fit: cover;" alt="YouTube Thumbnail">
                            <img src="asset/picture/play-button-embed.png" width="200"
            ...
            <div class="col-xl-4">
                <p><iframe src="https://www.instagram.com/axlramanda/embed" style="border-radius: 10px;" width="100%"
                        height="380" frameborder="10" scrolling="no" allowtransparency="true"></iframe>
                </p>
            </div>
        </div>
    </div>
