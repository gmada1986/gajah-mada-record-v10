...
<body>
                ...
                <center>
                    <div class="row content-center-one">
                        ...
                        <div class="col-xl-9 mt-5 mb-4 lne-hght">
                            <a href="https://www.instagram.com/syahrulhikmal/"> 
                        ...
                        <div class="col-xl-9 lne-hght">
                            <a href="https://www.youtube.com/watch?v=MrI0qwpc-g8">
    ...
    <div class="ngtop">
        <h1 class="text-center fw-bold text-white" style="margin-top: 4%;">SYAHRUL HIKMAL</h1>
        <center>
    ...
    <div class="container text-white" style="margin-top: 6%;">
        <div class="mb-3" style="max-width: 100%;">
            <div class="row g-0">
                <center>
                    <img src="asset/syahrulhikmal.jpg"
            ...
            <div class="row">
                <div class="col-xl-10"
                    ...
                    <p class="card-text">Syahrul Hikmal lahir di Padang pada 10 Februari 2002. Ia dikenal sebagai Content Creator Drama “Bucin” bersama kekasihnya, Yusi. Ia pernah menjadi penjaga toko di "Warkop" di Jakarta Syahrul Hikmal suka menyanyi dan memulai karirnya dengan Gajah Mada Record pada tahun 2022.</p>
                </div>
                {{-- <p>&nbsp;</p>
                <div class="col-xl-10"
                    style="max-width: 1020px; justify-content: center;align-content: center;margin: auto;display: flex;">
            ...
            <div class="col-xl-6">
                <div style="margin-top: 2%;">
                    <p style="position: relative;">
                        <a href="https://www.youtube.com/watch?v=MrI0qwpc-g8" target="_blank">
                            <img src="https://img.youtube.com/vi/MrI0qwpc-g8/maxresdefault.jpg"  width="100%"  height="100%"  style="border-radius: 10px; object-fit: cover;"  alt="YouTube Thumbnail">
                            <img src="asset/picture/play-button-embed.png"  width="200"  style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1;"  alt="YouTube Logo">
                        </a>
                    </p>
                </div>
            </div>
            <div class="col-xl-6">
                <p><iframe src="https://www.instagram.com/syahrulhikmal/embed" style="border-radius: 10px;" width="100%" height="380" frameborder="10" scrolling="no" allowtransparency="true"></iframe>
                </p>
            </div>
        </div>
    </div>
