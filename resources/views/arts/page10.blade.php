...
<body>
                ...
                <center>
                    <div class="row content-center-one">
                        ...
                        <div class="col-xl-9 mt-5 mb-4 lne-hght">
                            <a href="https://www.instagram.com/ukebasquad/"> 
                        ...
                        <div class="col-xl-9 lne-hght">
                            <a href="https://www.youtube.com/watch?v=ifi7jZmFp-Y">
    ...
    <div class="ngtop">
        <h1 class="text-center fw-bold text-white" style="margin-top: 4%;">UKEBA SQUAD</h1>
        <center>
        ...
        <div class="mb-3" style="max-width: 100%;">
            ...
            <div class="row">
                <div class="col-xl-10"
                    ...
                    <p class="card-text">TUKEBA SQUAD merupakan band yang instrumen utamanya adalah ukulele yang terbentuk pada tanggal 8 Juni 2014 di
                        kota Yogyakarta dan merupakan band ukulele pertama di Indonesia bahkan di dunia (fullband
                        format).</p>
                </div>
                <p>&nbsp;</p>
                <div class="col-xl-10"
                    style="max-width: 1020px; justify-content: center;align-content: center;margin: auto;display: flex;">
                    <p class="card-text text-break"> Mereka mempunyai misi 'Mensosialisasikan Ukulele dan Masyarakat Mengutuk' yang seru dan membuat penasaran #UkeShow. Terdiri dari 4 personel dengan latar belakang musik berbeda membuat Pasukan Ukeba ini disukai karedok bin gado-gado alias lengkap dari rock, metal, pop hingga dangdut tapi tidak menghilangkan ciri khas bandnya sehingga tampilannya selalu menarik dan membuat bapak ibu sekalian penasaran untuk terus datang ke setiap #UkeShow mereka di berbagai tempat di seluruh Indonesia. </p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-xl-6">
                <div style="margin-top: 2%;">
                    <p style="position: relative;">
                        <a href="https://www.youtube.com/watch?v=ifi7jZmFp-Y" target="_blank">
                            <img src="https://img.youtube.com/vi/ifi7jZmFp-Y/maxresdefault.jpg" 
                                 width="100%" 
                                 height="100%" 
            ...
            <div class="col-xl-6">
                <p><iframe src="https://www.instagram.com/ukebasquad/embed" style="border-radius: 10px;"
