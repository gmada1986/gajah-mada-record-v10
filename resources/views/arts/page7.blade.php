    ...
    <body>
                    ...
                    <center>
                        <div class="row content-center-one">
                            ...
                            <div class="col-xl-9 mt-5 mb-4 lne-hght">
                                <a href="https://www.instagram.com/zinidinzidan.official/"> 
                            ...
                            <div class="col-xl-9 mb-4 mt-2 lne-hght">
                                <a href="https://open.spotify.com/intl-id/artist/0pOHLBsuDuZb6DH1r5uSfb">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" class="rspnsive-iconx"
                                        viewBox="0 0 256 256">
                                        <path fill="#1ED760"
                            ...
                            <div class="col-xl-9 lne-hght">
                                <a href="https://www.youtube.com/watch?v=za1XqMrSufA">
        ...
        <div class="ngtop">
            <h1 class="text-center fw-bold text-white" style="margin-top: 4%;">ZINIDIN ZIDAN</h1>
            <center>
            ...
            <div class="mb-3" style="max-width: 100%;">
                ...
                <div class="row">
                    <div class="col-xl-10"
                        ...
                        <p class="card-text">Zinidin Zidan lahir di Parigi Moutong, Sulawesi Tengah pada tanggal 1 Januari 2001. Karir menyanyi Zidan berawal dari mengcover lagu di Tiktok hingga akhirnya menjadi viral dengan SUARA "CENGKOK" UNIKnya yang mendapat banyak like dan view. Pada tahun 2021 Zidan bergabung dengan Gajah Mada Records dan menghasilkan karya orisinal.</p>
                    </div>
                    <p>&nbsp;</p>
                    <div class="col-xl-10"
                        style="max-width: 1020px; justify-content: center;align-content: center;margin: auto;display: flex;">
                        <p class="card-text text-break">
                            COVER "AKU BUKAN JODOHNYA" ditonton 78 juta kali dalam 2 BULAN. Saluran Youtube 2,1 Juta Pelanggan dalam 2 BULAN dimulai 15 Oktober 2021 TIKTOK 4,8 Juta pengikut (tumbuh dari 1 Juta menjadi 4,8 Juta pengikut dalam 3 BULAN)
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-xl-4">
                    <p><iframe loading="lazy" src="https://open.spotify.com/embed/artist/0pOHLBsuDuZb6DH1r5uSfb"
                            width="100%" height="380" frameborder="0"></iframe></p>
                </div>
                <div class="col-xl-4">
                    <div style="margin-top: 15%; margin-bottom: 10%;">
                        <p style="position: relative;">
                            <a href="https://www.youtube.com/watch?v=za1XqMrSufA" target="_blank">
                                <img src="https://img.youtube.com/vi/za1XqMrSufA/maxresdefault.jpg" 
                                    width="100%" 
                                    height="100%" 
                ...
                <div class="col-xl-4">
                    <p><iframe src="https://www.instagram.com/zinidinzidan.official/embed" style="border-radius: 10px;"
