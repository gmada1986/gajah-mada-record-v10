...
<body>
                ...
                <center>
                    <div class="row content-center-one">
                        ...
                        <div class="col-xl-9 mt-5 mb-4 lne-hght">
                            <a href="https://www.instagram.com/devtapramesthi/"> 
                        ...
                        <div class="col-xl-9 mb-4 mt-2 lne-hght">
                            <a href="https://open.spotify.com/intl-id/artist/1y5ZqntfVba7jWiyDGYPMx">
                                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" class="rspnsive-iconx"
                                    viewBox="0 0 256 256">
                                    <path fill="#1ED760"
                        ...
                        <div class="col-xl-9 lne-hght">
                            <a href="https://www.youtube.com/watch?v=Jt7ndn0aJ-E">
    ...
    <div class="ngtop">
        <h1 class="text-center fw-bold text-white" style="margin-top: 4%;">DEVTA PRAMESTHI</h1>
        <center>
    ...
    <div class="container text-white" style="margin-top: 6%;">
        <div class="mb-3" style="max-width: 100%;">
            <div class="row g-0">
                <center>
                    <img src="asset/DEVTA_PRAMESTHI.jpg"
            ...
            <div class="row">
                <div class="col-xl-10"
                    ...
                    <p class="card-text">Devta Pramesthi, lahir pada tanggal 27 Agustus 1997 di Purworejo. Wanita bersuara unik ini MENGEJUTKAN semua juri THE VOICE INDONESIA 2019, KILA 2020, RISING STAR INDONESIA DANGDUT 2021, INDONESIA MENCARI BAKAT 2021 dengan SUARA dan KETERAMPILAN INSTRUMENTALnya. Devta Pramesthi bergabung dengan Gajah Mada Record sejak tahun 2021 dan menghasilkan karya-karya yang luar biasa.</p>
                </div>
                {{-- <p>&nbsp;</p>
                <div class="col-xl-10"
                    style="max-width: 1020px; justify-content: center;align-content: center;margin: auto;display: flex;">
...
Selamanya (2008), Bintang yang Bersinar (2010), Cahaya Terang (2011), Essence of Life (2015), RE.VIV.AL (2021).
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-xl-4">
                <p><iframe loading="lazy" src="https://open.spotify.com/embed/artist/1y5ZqntfVba7jWiyDGYPMx"
                        width="100%" height="380" frameborder="0"></iframe></p>
            </div>
            <div class="col-xl-4">
                <div style="margin-top: 15%; margin-bottom: 10%;">
                    <p style="position: relative;">
                        <a href="https://www.youtube.com/watch?v=Jt7ndn0aJ-E" target="_blank">
                            <img src="https://img.youtube.com/vi/Jt7ndn0aJ-E/maxresdefault.jpg" 
                                 width="100%" 
                                 height="100%" 
            ...
            <div class="col-xl-4">
                <p><iframe src="https://www.instagram.com/devtapramesthi/embed" style="border-radius: 10px;"
