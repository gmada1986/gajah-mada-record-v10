...
<body>
                ...
                <center>
                    <div class="row content-center-one">
                        ...
                        <div class="col-xl-9 mt-5 mb-4 lne-hght">
                            <a href="https://www.instagram.com/valdynyonkofficial_/">
                        ...
                        <div class="col-xl-9 mb-4 mt-2 lne-hght">
                            <a href="https://open.spotify.com/intl-id/album/2SsiaoJZ11KIyGkPrB9oUc">
                                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" class="rspnsive-iconx"
                                    viewBox="0 0 256 256">
                                    <path fill="#1ED760"
                        ...
                        <div class="col-xl-9 lne-hght">
                            <a href="https://www.youtube.com/watch?v=W9jk6PLjSYQ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" class="rspnsive-iconx"
                                    viewBox="0 0 72 72">
                                    <path fill="#ea5a47"
    ...
    <div class="ngtop" style="margin-top: 9%;">
        <h1 class="text-center fw-bold text-white" style="margin-top: 4%;">VALDY NYONK</h1>
        <center>
    ...
    <div class="container text-white" style="margin-top: 6%;">
        <div class="mb-3" style="max-width: 100%;">
            <div class="row g-0">
                <center>
                    <img src="asset/valdy-nyonk2.JPG" class="img-fluid rounded mb-5" alt="..." style="width: 1000px;">
                </center>
            </div>
            <div class="row">
                <div class="col-xl-10"
                    style="max-width: 1020px; justify-content: center;align-content: center;margin: auto;display: flex;">
                    <p class="card-text">Pemilik nama asli Muhammad Valdy ini adalah laki-laki
                        yang lahir di Kendari, Sulawesi Tenggara pada tanggal 2
                        Februari. Agama yang dianutnya adalah Islam.Valdy Nyonk diketahui viral di TikTok setelah
                        menyanyikan lagu Sakit Gigi dengan suaranya yang
                        merdu.</p>
                </div>
                <p>&nbsp;</p>
                <div class="col-xl-10"
                    ...
                    <p class="card-text text-break">
                        Valdy Nyonk mulai dikenal oleh publik saat dirinya terjun
                        sebagai konten kreator di media sosial YouTube gaes.
                        Awalnya ia sering mengunggah konten saat dirinya
                        mengcover beberapa lagu milik penyanyi terkenal di
                        channel tersebut.Kemudian ia pun merambah ke dunia TikTok dan sukses
                        membuat dirinya viral karene suaranya yang sangat
                        merdu gaes.
                    </p>
                </div>
            </div>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-xl-4">
                <p><iframe loading="lazy" src="https://open.spotify.com/embed/artist/2yiIcmdxcECFqPBlEZcOJP"
                        width="100%" height="380" frameborder="0"></iframe></p>
            </div>
            <div class="col-xl-4">
                <div style="margin-top: 15%; margin-bottom: 10%;">
                    <p style="position: relative;">
                        <a href="https://www.youtube.com/watch?v=W9jk6PLjSYQ" target="_blank">
                            <img src="https://img.youtube.com/vi/W9jk6PLjSYQ/maxresdefault.jpg" width="100%"
                                height="100%" style="border-radius: 10px; object-fit: cover;" alt="YouTube Thumbnail">
                            <img src="asset/picture/play-button-embed.png" width="100"
            ...
            <div class="col-xl-4">
                <p><iframe src="https://www.instagram.com/valdynyonkofficial_/embed" style="border-radius: 10px;"
